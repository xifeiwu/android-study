...
public class ConfigXmlParser {
    private static String TAG = TestCordovaActivity.TAG;
    ...
    public void parse(Activity action) {
        ...
        LOG.d(TestCordovaActivity.TAG, id + ": " + action.getClass().getPackage().getName());
        if (id == 0) {
        ...
        LOG.d(TAG, id + ": " + action.getPackageName());
    ...
    public void parse(XmlResourceParser xml) {
        ...
        while (eventType != XmlResourceParser.END_DOCUMENT) {
            ...
            {
                String strNode = xml.getName();
                LOG.d(TAG, "END_TAG:" + strNode);
                if (strNode.equals("feature")) {
                    pluginEntries.add(new PluginEntry(service, pluginClass, onload, urlMap));
                    LOG.d(TAG, "service:" + service + "  -  pluginClass:" +  pluginClass);
                    service = "";
                    pluginClass = "";
                    insideFeature = false;
                    onload = false;
